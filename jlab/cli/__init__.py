...
from jlab.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/jetson-ai-lab-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from jlab.cli._commands import cli as _cli_group
    from jlab.cli._commands import doctor as _doctor_cmd
    from jlab.cli._commands import explain as _explain_cmd
    from jlab.cli._commands import learn as _learn_cmd
    from jlab.cli._commands import overview as _overview_cmd
    from jlab.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="jetson-ai-lab-cli",
        description="jetson-ai-lab-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
