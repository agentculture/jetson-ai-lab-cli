"""``jetson-ai-lab-cli learn`` — the learnability affordance.
...
_TEXT = """\
jetson-ai-lab-cli — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  jetson-ai-lab-cli whoami             Identity from culture.yaml.
  jetson-ai-lab-cli learn              This self-teaching prompt.
  jetson-ai-lab-cli explain <path>...  Markdown docs for any noun/verb path.
  jetson-ai-lab-cli overview           Descriptive snapshot of the agent.
  jetson-ai-lab-cli doctor             Check the agent-identity invariants.
  jetson-ai-lab-cli cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "jetson-ai-lab-cli explain <path>",
    }
