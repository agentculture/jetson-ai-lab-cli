...
Every failure inside jetson-ai-lab-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`jlab.cli._output`,
...
# Exit-code policy. Documented in ``jetson-ai-lab-cli learn`` output.
# 0      = success
