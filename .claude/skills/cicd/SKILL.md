...
type: command
description: >
  jetson-ai-lab-cli's CI/CD lane, layered on `agex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in jetson-ai-lab-cli, handling
...
# CI/CD — jetson-ai-lab-cli edition
