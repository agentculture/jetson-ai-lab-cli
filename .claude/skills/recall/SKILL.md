...
description: >
  ...
  defaults queries to this agent's PERSONAL, PRIVATE scope (`--scope jetson-ai-lab-cli
...
- `--scope NAME` / `--visibility public|private` — scope isolation (no private
  ...
  (`--scope jetson-ai-lab-cli --visibility private`, suffix read from `culture.yaml`),
